...
- (void)viewDidLoad {
    ...
    TitleMenuView *titleMenu = [[TitleMenuView alloc]initWithFrame:CGRectMake(0, 64, mainWidth, mainHeight-20) WithViewControllers:array WithStyle:TitleMenuStyleDefault WithTitleFont:15 AndTitleInterval:20];
    
    titleMenu.btnSelectedColor = [UIColor redColor];

    titleMenu.btnNormalColor = [UIColor darkGrayColor];
    
    titleMenu.sliderColor = [UIColor lightGrayColor];
    
    titleMenu.titleMenuBackGroundColor = [UIColor greenColor];
